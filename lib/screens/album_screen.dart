...
class _AlbumScreenState extends State<AlbumScreen> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(appBar: AppBar(title: Text("Album"),),body: _body(),);
  }
  _body(){
    return Column(children: [
      BlocBuilder<AlbumBloc, AlbumState>(builder: (BuildContext context,AlbumState state){
  ...
  _listAlbum(List<Album> album){
    return Expanded(child: ListView.builder(itemBuilder: (_,index){
